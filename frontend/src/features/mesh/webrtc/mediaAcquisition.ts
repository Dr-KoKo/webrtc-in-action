...
//
// `acquireLocalMedia` is reused from the 001 helper — it is a pure
// function with no 001-specific state, and reusing it avoids two
// drifting implementations of the DOMException → contract enum
// classifier (which is governed by the v2 contract too).

import { useEffect, useRef } from "react";
import { acquireLocalMedia } from "../../../webrtc/media-acquisition";
