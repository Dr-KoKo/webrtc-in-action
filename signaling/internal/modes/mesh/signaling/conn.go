// Package signaling implements the WebRTC verbs for the 002 mesh
// contract: admission, media-readiness, pair negotiation/trickle/
// media-state, roster fan-out, reconnect, presence/leave.
// See specs/signaling-architecture.md §2.3 (Ring 3) and §3.2.
//
...
// room.Conn is expected (e.g. RoomManager.JoinOrCreate), without a
// downcast.
//
